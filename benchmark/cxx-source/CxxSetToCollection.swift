...
extension SetOfU32.const_iterator : Equatable, UnsafeCxxInputIterator { }

extension SetOfU32: CxxConvertibleToCollection {}


@inline(never)
public func run_CxxSetOfU32_to_Array(_ n: Int) {
  let setOfU32 = makeSet32(setSize)
  for _ in 0..<n {
    blackHole(Array(setOfU32))
  }
}
